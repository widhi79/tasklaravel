        ...
        $(document).ready(function() {
            ...
            $('#tabelTasks').DataTable({
                ajax: {
                    url: '/api/tasks',
                    data: {
                        user_name: '<?php echo e(session('user_email')); ?>'
                    },
                    dataSrc: '',
                    headers: {
...
<?php echo $__env->make('template\tmpl', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel\task-manager\resources\views/tasks.blade.php ENDPATH**/ ?>