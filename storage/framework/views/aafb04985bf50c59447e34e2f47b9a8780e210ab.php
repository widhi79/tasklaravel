...
<body>
    <!-- HEADER SECTION -->
    <div id="page-wrapper">
        <img class="img-responsive" src="<?php echo e(URL('assets/img/header.jpg')); ?>" width="100%" alt="Header Image">
    </div>
        ...
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <li><b><a href="<?php echo e(URL('/home')); ?>"><i class="fa fa-home fa-2x"></i>Home</a></b></li>
                        <li><b><a href="#"
                    ...
                    <?php else: ?>
                        <li><b><a href="<?php echo e(route('login')); ?>"><i
            ...
            <div class="alert alert-success alert-dismissable">
                ...
                <?php if(session('user_email')): ?>
                    <p>Welcome, <?php echo e(session('user_email')); ?>!</p>
                    <!--<p>Token: <?php echo e(session('api_token')); ?>!</p>-->
                <?php endif; ?>
            </div>
        </div>
    </div><!-- /.row -->
...
<?php /**PATH D:\project\laravel\task-manager\resources\views/template\tmpl.blade.php ENDPATH**/ ?>